...
google::protobuf::uint32 Invocation::id() const {
    return invocation_.id();
}
...
void MessageProcessor::send_response(::google::protobuf::uint32 id, google::protobuf::MessageLite *response) {
